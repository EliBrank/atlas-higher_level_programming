...
class Rectangle:
    ...
    """keeps track of how many times Rectangle is instanstiated"""
    ...
    def square(cls, size=0):
        ...
        Args:
            size: value for width and height

        Returns: Rectangle object (square)
        """
    ...
    def __init__(self, width=0, height=0):
        ...
        """increments variable for number of Rectalngles instanstiated"""
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            ...
            rect_2: second Rectangle object to compare

        Returns: larger Rectangle object (rect_1 if equal)
        """
    ...
    def __str__(self):
        ...
        Returns: Rectangle represented using print_symbol
        """
        ...
        if self.__width != 0 and self.__height != 0:
            for row in range(self.__height):
                for i in range(self.__width):
                    print_result += str(self.print_symbol)
    ...
    def __del__(self):
        """adds notice for instance deletion"""
        print("Bye rectangle...")
        del self

        Rectangle.number_of_instances -= 1
        """decrements variable for number of Rectalngles instanstiated"""
